...
- **`docs/blueprints/` は会員特典（AI社員室 2,980円/月 の週1配信）の原稿ですが、
  public リポジトリに入っているので誰でも読めます。** サイトからは配信されませんが、
  GitHub からは読めます。扱いは未決です（→ `docs/blueprints/README.md` の冒頭）。
  ここに新しい設計図を足すと、無料で読める本数が増えることを踏まえてください。
